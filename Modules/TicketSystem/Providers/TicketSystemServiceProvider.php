...
use Modules\TicketSystem\Http\Repositories\TicketRepository;
...
use Modules\TicketSystem\Http\Services\TicketService;
...
class TicketSystemServiceProvider extends ServiceProvider
{
     ...
     */
    protected $moduleName = 'TicketSystem';

    /**
     * @var string $moduleNameLower
     */
    protected $moduleNameLower = 'ticketsystem';
    ...
    public function register()
    {
        ...
        $this->app->bind(RepositoryInterface::class, TicketRepository::class);
        $this->app->bind(TicketInterface::class, TicketService::class);
        $this->app->bind(TicketSearchInterface::class, TicketSearchService::class);
    }
